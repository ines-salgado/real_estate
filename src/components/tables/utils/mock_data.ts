import { createData, createSmallTableData } from "./data_creation";
import { Data, HeadCell, SmallData } from "./models";
...
export { headCells, smallTableHeadCells, rows, smallTableRows };
